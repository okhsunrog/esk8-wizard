...
/// representable range is 0.99996948242 to -0.99996948242, in steps of
/// 0.00003051757.
...
extern "C" {
void *memmove8(void *dst, const void *src,
               uint16_t num); ///< Faster alternative to memmove() on AVR
void *memcpy8(void *dst, const void *src, uint16_t num)
    __attribute__((noinline)); ///< Faster alternative to memcpy() on AVR
void *memset8(void *ptr, uint8_t value, uint16_t num)
    __attribute__((noinline)); ///< Faster alternative to memset() on AVR
}
#else
...
/// Fast linear interpolation functions, such as could be used for Perlin noise,
/// etc.
///
...
static inline uint32_t get_millisecond_timer() {
...
/// Preprocessor-based class "template" for ::CEveryNTime, used with
/// `EVERY_N_TIME` timekeepers. Classes to implement ::EVERY_N_MILLIS,
/// ::EVERY_N_SECONDS,
...
/// @warning This specific class isn't actually part of the library! It's
/// created using a preprocessor macro (::INSTANTIATE_EVERY_N_TIME_PERIODS) as
...
/// Checks whether to execute a block of code every N bseconds, using a custom
/// instance name
...
/// Checks whether to execute a block of code every N minutes, using a custom
/// instance name
...
/// Checks whether to execute a block of code every N hours, using a custom
/// instance name
...
// purposes of Doxygen documentation generation. They do not affect your
// program.
